...
def post_video_from_blog(blogId, postId, language_code, amara_headers):
    ...
    videoId = amara.amara_tools.get_video_id(video_url='https://youtu.be/'+videoId,language_code=language_code,
                                             amara_headers=amara_headers)
    amara.amara_tools.get_actions(videoId ,language_code, amara_headers)
    amara.amara_tools.post_subtitles(videoId, language_code, conv_lyrics, amara_headers)
...
def subtitles_workflow(blogId, postId, language_code, amara_headers):
    test_add_amaratags(blogId, postId, language_code)
    post_video_from_blog(blogId, postId, language_code, amara_headers)
